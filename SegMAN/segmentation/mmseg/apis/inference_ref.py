...
def init_segmentor_ref(config, checkpoint=None, device='cuda:0', CLASSES=None,PALETTE=None ):
...
def inference_segmentor_ref(model, imgs, geo_edge):
...
def show_result_pyplot_ref(model,
                       img,
                       result,
                       palette=None,
                       fig_size=(15, 10),
