...
from mmseg.apis import init_random_seed_dnf, set_random_seed_dnf, train_segmentor_dnf
...
def main():
    ...
    seed = init_random_seed_dnf(args.seed, device=cfg.device)
    seed = seed + dist.get_rank() if args.diff_seed else seed
    logger.info(f'Set random seed to {seed}, '
                f'deterministic: {args.deterministic}')
    set_random_seed_dnf(seed, deterministic=args.deterministic)
    cfg.seed = seed
    meta['seed'] = seed
